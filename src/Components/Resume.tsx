...
const Resume: React.FC = () => {
    return (
        <div id='resume' className='w-full flex flex-col gap-12 sm:flex-col md:flex-col sm:min-w-fit md:min-w-fit items-center justify-center mb-40 overflow-x-hidden'>
